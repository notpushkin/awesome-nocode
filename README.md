...
*Implementations of algorithms and design patterns.*
...
*Compile software from no source code.*
...
## No Code Analysis and Linter

*Libraries and tools for analysing, parsing and manipulation no code bases.*
...
*Libraries for version and environment management.*
...
*Functional Programming with nocode.*
...
*Frameworks for developing serverless code.*
